...
namespace SteamP2PTransport
{
    public class SteamP2PTransport : Transport
    {
        ...
        {
            if (NetworkingManager.Singleton.LogLevel <= LogLevel.Developer) UnityEngine.Debug.Log("SteamP2PTransport - DisconnectLocalClient");
        ...
        {
            if (NetworkingManager.Singleton.LogLevel <= LogLevel.Developer) UnityEngine.Debug.Log("SteamP2PTransport - DisconnectRemoteClient clientId: " + clientId);

            if (!connectedUsers.ContainsKey(clientId))
            {
                if (NetworkingManager.Singleton.LogLevel <= LogLevel.Error) UnityEngine.Debug.Log("SteamP2PTransport - Can't disconect client, client not connected, clientId: " + clientId);
                return;
            }
            ...
            { //Need to delay the closing of the p2p sessions to not block the disconect message before it is sent.
                ...
                if (NetworkingManager.Singleton.LogLevel <= LogLevel.Developer) UnityEngine.Debug.Log("SteamP2PTransport - DisconnectRemoteClient - has Closed P2P Session With clientId: " + clientId);
            }));
        ...
        public override ulong GetCurrentRtt(ulong clientId)
        {
            if (isServer)
            {
                ...
                {
                    if (NetworkingManager.Singleton.LogLevel <= LogLevel.Error) UnityEngine.Debug.Log("SteamP2PTransport - Can't GetCurrentRtt from client, client not connected, clientId: " + clientId);
                }
            }
            else
            {
        ...
        public override void Init()
        {
            ...
            {
                if (NetworkingManager.Singleton.LogLevel <= LogLevel.Error) UnityEngine.Debug.Log("SteamP2PTransport - Init - Steamworks.NET SteamManager.Initialized not found, SteamP2PTransport can not run without it");
                return;
            }
            ...
            if (!propertyValue)
            {
                if (NetworkingManager.Singleton.LogLevel <= LogLevel.Error) UnityEngine.Debug.Log("SteamP2PTransport - Init - Steamworks.NET is not Initialized, SteamP2PTransport can not run without it");
                return;
            }
            ...
            while (currentPollChannel < channelSendTypes.Count)
            {
                if (SteamNetworking.IsP2PPacketAvailable(out uint msgSize, currentPollChannel))
                {
                    ...
                    if (messageBuffer.Length < msgSize)
                    {
                        ...
                        if (NetworkingManager.Singleton.LogLevel <= LogLevel.Developer) UnityEngine.Debug.Log("SteamP2PTransport - PollEvent - Increase buffer size to: " + msgSize);
                    }
        ...
        public override void Send(ulong clientId, ArraySegment<byte> data, string channelName)
        {
            ...
            {
                if (NetworkingManager.Singleton.LogLevel <= LogLevel.Error) UnityEngine.Debug.Log("SteamP2PTransport - Can't Send to client, channel with channelName: " + channelName + " is not present");
                return;
            }
            ...
            else
            {
                ...
                {
                    if (NetworkingManager.Singleton.LogLevel <= LogLevel.Error) UnityEngine.Debug.Log("SteamP2PTransport - Can't Send to client, client not connected, clientId: " + clientId);
                }
            }
        }
        ...
        {
            if (NetworkingManager.Singleton.LogLevel <= LogLevel.Developer) UnityEngine.Debug.Log("SteamP2PTransport - Shutdown");
        ...
        public override SocketTasks StartServer()
        {
            ...
            if (NetworkingManager.Singleton.LogLevel <= LogLevel.Developer) UnityEngine.Debug.Log("SteamP2PTransport - StartServer - ConnectToCSteamID: " + SteamUser.GetSteamID().m_SteamID.ToString());
        ...
        private void CloseP2PSessions()
        {
            ...
            serverUser = null;
            if (NetworkingManager.Singleton.LogLevel <= LogLevel.Developer) UnityEngine.Debug.Log("SteamP2PTransport - CloseP2PSessions - has Closed P2P Sessions With all Users");
        }

        private void OnP2PSessionRequest(P2PSessionRequest_t request)
        {
            if (NetworkingManager.Singleton.LogLevel <= LogLevel.Developer) UnityEngine.Debug.Log("SteamP2PTransport - OnP2PSessionRequest - m_steamIDRemote: " + request.m_steamIDRemote);
        ...
        {
            if (NetworkingManager.Singleton.LogLevel <= LogLevel.Developer) UnityEngine.Debug.Log("SteamP2PTransport - OnP2PSessionConnectFail - m_steamIDRemote: " + request.m_eP2PSessionError.ToString() + " Error: " + request.m_eP2PSessionError.ToString());
